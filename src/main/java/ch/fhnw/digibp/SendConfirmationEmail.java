...
public class SendConfirmationEmail implements JavaDelegate {
  ...
  public void execute(DelegateExecution execution) throws Exception {
    ...
    "\nAffected Application: " + execution.getVariable("affectedApplication")  +

    "\nSystem ID: " + execution.getVariable("systemID")  +
    "\nStep by Step Instruction: " + execution.getVariable("stepByStep")  +
    "\nCustomer Name: " + execution.getVariable("customerName")  +
    "\nCustomer Mail: " + execution.getVariable("customerMail")  +
    "\nCustomer Phone: " + execution.getVariable("customerPhone")  +

    "\nReal Incident: " + execution.getVariable("isReallyIncident")  +
    "\nSupported: " + execution.getVariable("incidentSupported")  +
    ...
    String json = new JSONObject()
    		  .put("email", email)
    		  .put("msg", msg)
    		  .put("title", "Incident Notification")
    		  .toString();
