...
- Login with demo for the Username and demo for the Password 
- Cklick on tasklist - After that cklick on start Process    | ![alt text](https://github.com/DigiBP/digibp-saentis/blob/master/pics/StartProcess.png)|
